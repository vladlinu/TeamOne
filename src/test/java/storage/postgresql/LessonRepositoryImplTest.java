...
public class LessonRepositoryImplTest {
	...
	public void findLessonsByGroupIdFromInterval() {
		...
		assertEquals("2020-11-16T08:30", lesson1.getDateTime()
												.toString());
		...
		assertTrue(lesson1.getIsPresent()
						  .get("vasya092"));
		assertTrue(lesson1.getIsPresent()
						  .get("wqa092"));
		assertTrue(lesson1.getIsPresent()
		...
		assertEquals("2020-11-16T08:05", lesson1.getDateTime()
												.toString());
		assertNull(lesson1.getHomework());
	...
	@Test
	void saveNewEntity() {
		Lesson lesson1 = new Lesson(11111, LocalDateTime.now(), "description1",
				"Math1", null, 1, "julius44", new HashMap<String, Boolean>());
		Lesson lesson2 = new Lesson(55555, LocalDateTime.now(), "description2",
				"Math2", null, 2, "julius44", new HashMap<String, Boolean>());
		Lesson lesson3 = new Lesson(11111, LocalDateTime.now(), "description3",
				"Math3", "Lab 6", 3, "julius44", new HashMap<String, Boolean>());
		...
		Assert.assertEquals(saveNewLesson3, null);
	}
	...
	public void findAll() {
		...
		assertEquals("2020-11-16T09:05", lesson1.getDateTime()
												.toString());
	...
	public void update() {
		...
		try {
			while (resultSet.next()) {
				...
				String dateResult = resultSet.getDate(2)
											 .toString();
				String timeResult = resultSet.getTime(3)
											 .toString();
				...
				ResultSet presentsResult2 = connector.executeStatement(String.format("SELECT * FROM Presents WHERE login = 'wqa092' AND lesson_id = 1"));
